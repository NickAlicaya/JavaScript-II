...
ticketPriceTotal = runners.reduce(function(num1, num2) {
	return num1 + num2.donation;
}, 0);
...
// Problem 1
//Create a list of the runners last name and age using forEach.
let lastNameAndEmail = [];
runners.forEach(function(runner) {
	lastNameAndEmail.push(`${runner.last_name} ${runner.email}`);
});
